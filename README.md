...
- **Building:** Next-gen SaaS tools and AI-powered automation workflows.
- **Learning:** Advanced Cloud Architecture ($AWS$ & $GCP$) and Scalable Backend Systems.
- **Scaling:** Moving from "it works" to "it scales for millions."

### 🤝 Let's Collaborate
| I'm looking for... | I can help with... |
| :--- | :--- |
| 🚀 Interesting Startups | 🏗️ Backend Architecture (Node/Python/PHP) |
| 🌐 Open-source Developer Tools | 🤖 AI & LLM Integrations |
